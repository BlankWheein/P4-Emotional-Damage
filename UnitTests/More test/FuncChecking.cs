...
namespace UnitTests.Daniel
{
    ...
    public class FuncChecking : UnitTestInitializer 
    {
        ...
        {
            var root = Parse(new StringBuilder("int[3] kage(int[2] a, int[3] a2) {int[3] ice; ice[2] = a[1] + a2[2]; return ice;} int[2] arr; int[3] lol; int[3] final; final = kage(arr, lol);"));
        ...
        {
            var root = Parse(new StringBuilder("int[3] kage(int[2] a, int[3] a2) {int[2] ice; ice[1] = a[1] + a2[2]; return ice;} int[2] arr; int[3] lol; int[1] final; final = kage(arr, lol);"));
            scope.Insert(SymbolType.Aint, "kage", row: 3, parameters: new List<Symbol>() { new("a", SymbolType.Aint, row: 2), new("a2", SymbolType.Aint, row: 3) }, isfunc: true);
            scope.Allocate("Func");
        ...
        {
            var root = Parse(new StringBuilder("int[2] kage(int[2] a) {int[2] ice; ice[1] = a[1]; return ice;} int[1] arr; int[2] final; final = kage(arr);"));
        ...
        {
            var root = Parse(new StringBuilder("int[2] kage(int[2] a) {int[2] ice; ice[1] = a[1]; return ice;} int[5] arr; int[2] final; final = kage(arr);"));
            scope.Insert(SymbolType.Aint, "kage", row: 2, parameters: new List<Symbol>() { new("a", SymbolType.Aint, row: 2) }, isfunc: true);
            scope.Allocate("Func");
            scope.Insert(SymbolType.Aint, "ice", row: 2);
            scope.ExitScope();

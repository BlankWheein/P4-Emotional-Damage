...
public interface IEmotionalDamageVisitor<Result> : IParseTreeVisitor<Result> {
	...
	/// <param name="context">The parse tree.</param>
	/// <return>The visitor result.</return>
	Result VisitNumArrMatrixValue([NotNull] EmotionalDamageParser.NumArrMatrixValueContext context);
	/// <summary>
	...
	/// <param name="context">The parse tree.</param>
	/// <return>The visitor result.</return>
	Result VisitBoolExpr([NotNull] EmotionalDamageParser.BoolExprContext context);
	/// <summary>

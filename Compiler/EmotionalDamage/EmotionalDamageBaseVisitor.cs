...
public partial class EmotionalDamageBaseVisitor<Result> : AbstractParseTreeVisitor<Result>, IEmotionalDamageVisitor<Result> {
	...
	/// <summary>
	/// Visit a parse tree produced by the <c>GradientDcl</c>
	/// labeled alternative in <see cref="EmotionalDamageParser.dcl"/>.
	/// <para>
	/// The default implementation returns the result of calling <see cref="AbstractParseTreeVisitor{Result}.VisitChildren(IRuleNode)"/>
	/// on <paramref name="context"/>.
	...
	/// <param name="context">The parse tree.</param>
	/// <return>The visitor result.</return>
	public virtual Result VisitGradientDcl([NotNull] EmotionalDamageParser.GradientDclContext context) { return VisitChildren(context); }
	/// <summary>
	...
	/// <param name="context">The parse tree.</param>
	/// <return>The visitor result.</return>
	public virtual Result VisitRandIdentifierStmt([NotNull] EmotionalDamageParser.RandIdentifierStmtContext context) { return VisitChildren(context); }
	/// <summary>

...
public partial class EmotionalDamageBaseVisitor<Result> : AbstractParseTreeVisitor<Result>, IEmotionalDamageVisitor<Result> {
	...
	/// <summary>
	/// Visit a parse tree produced by the <c>NumArrMatrixValue</c>
	/// labeled alternative in <see cref="EmotionalDamageParser.expr"/>.
	/// <para>
	/// The default implementation returns the result of calling <see cref="AbstractParseTreeVisitor{Result}.VisitChildren(IRuleNode)"/>
	/// on <paramref name="context"/>.
	...
	/// <param name="context">The parse tree.</param>
	/// <return>The visitor result.</return>
	public virtual Result VisitNumArrMatrixValue([NotNull] EmotionalDamageParser.NumArrMatrixValueContext context) { return VisitChildren(context); }
	/// <summary>
	...
	/// <param name="context">The parse tree.</param>
	/// <return>The visitor result.</return>
	public virtual Result VisitBoolExpr([NotNull] EmotionalDamageParser.BoolExprContext context) { return VisitChildren(context); }
	/// <summary>
